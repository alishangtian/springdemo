				...
				<table class="query-form">
					...
					<tr>
						...
						<td>
							...
							<dt:comboBox id="seasonSelect" height="28px" keyField="id" valueField="name" name="operationWorksInfoQB.produceSeasonId" hasNull="true" selectIndex="-1"></dt:comboBox>
						</td>
						
						<th>开始时间：</th>
						<td>
							<dt:dateInput id="queryStartTime" name="operationWorksInfoQB.beginTime" showTime="true" showOnbutton="true" width="176px" height="30px"/>
						</td>
						<th>结束时间：</th>
						<td>
							<dt:dateInput id="queryEndTime" name="operationWorksInfoQB.endTime"  showTime="true" showOnbutton="true" width="176px" height="30px"/>
						</td>
						<input name="operationWorksInfoQB.houseId" type="hidden" id="houseId"/>				
					</tr>
				</table>
			</form>
			<div class="query-form-btns">
				<dt:button id="queryDomainBtn" label="查询" type="ok"/>
				<dt:button id="resetOperationWorksInfoBtn" label="重置" type="cancel"/>
				<dt:button id="addOperationWorksInfoBtn" label="新增" type="ok"/>
				<dt:button id="delOperationWorksInfoBtn" label="删除" type="ok"/>
			</div>
			<dt:grid id="operationWorksInfoResult" shrinkToFit="true" multiSelect="true"
				jsonRoot="resultList" dataType="json" showPager="true" width="75%"
				caption="查询结果:所有温室"
