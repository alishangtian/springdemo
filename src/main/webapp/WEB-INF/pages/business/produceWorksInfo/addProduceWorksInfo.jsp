...
<html>
	...
	<body>
		...
		<caption>施肥录入</caption>
		<dt:input width="100" id="houseId" name="produceWorksInfo.houseId" value="${houseId }"  inputType="hidden"/>
			<tr>
				<th>种植季：</th>
				<td>
					<dt:comboBox datasource="${PrdcSeasonList }" id="prdcSeasion" height="28px" keyField="id" valueField="name" name="produceWorksInfo.produceSeasonId" hasNull="true" selectIndex="-1"></dt:comboBox>
				</td>
			...
			<th>施肥种类：</th>
				...
				<div id="domainDIV">
						...
						<dt:comboBox datasource="${values }" id="domainValues" height="28px" keyField="valueCode" valueField="valueName" name="produceWorksInfo.type" hasNull="true" selectIndex="-1"></dt:comboBox>
					</div>
				</td>
				<th>用量：</th>
				<td>
