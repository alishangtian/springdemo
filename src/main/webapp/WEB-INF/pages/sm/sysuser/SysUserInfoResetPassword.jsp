	...
	<div style="height: 100%">
		...
		<s:if test="sysUser!=null">
			<table class="condition" style="width: 100%;" align="center">
				<tr>
					<th width="25%">登录名称</th>
					<td width="25%"><s:property value="sysUser.loginName" />
					</td>
					<th width="25%">用户失效时间</th>
					<td width="25%" id="tdUserExpTime"><s:date
							name="sysUser.userExpTime" format="yyyy-MM-dd HH:mm:ss" />
					</td>
				</tr>
				<tr>
			...
			<s:if test="sysUser!=null && sysUser.staff!=null">
				<table class="condition" style="width: 100%;" align="center">
					...
					<tr>
						...
						<th width="25%">电子邮箱</th>
						<td width="25%"><s:property value="sysUser.staff.email" />
						</td>
					</tr>
				</table>
			</s:if>
			<s:if test="sysUser!=null && sysUser.sysDept!=null">
				...
				<div class="ui-widget-header func-header">新密码接收邮箱</div>
				<table class="condition" style="width: 100%;" align="center">
					<tr>
						<th width="25%">电子邮箱</th>
						<td width="50%"><s:if
								...
								<dt:input inputType="email" id="email" prompt="电子邮箱"
									required="true" value="${sysUser.staff.email}" />
							</s:if></td>
						<td width="25%"><dt:button id="BTN_RESET" label="重置"
								disabled="true"></dt:button>
							<div id="retMsg"></div></td>
					</tr>
				</table>
