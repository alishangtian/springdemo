...
<script type="text/javascript"
	src="<%=contextPath%>/js/func.busiParammanager.js"></script>
</head>
<body>
	<div class="ui-widget-content func-panel">
		<div class="ui-widget-header func-header">
			业务参数管理 <span style="float: right;"> <a id="enableBusiParamSts"
				href="javascript:void(0)" onclick="editBusiParamSts('T');">启用</a> <a
				id="disableBusiParamSts" href="javascript:void(0)"
				onclick="editBusiParamSts('F');">停用</a> <a id="editBusiParam"
				href="javascript:void(0)" onclick="editBusiParamDialogShow();">编辑</a>
			</span>
		</div>
		<table class="condition" width="100%" align="center">
			<tr>
				...
				<th>参数代码：</th>
				<td><dt:input width="100" id="queryParamCode"></dt:input></td>
				<th>参数名称：</th>
				<td><dt:input width="100" id="queryParamName"></dt:input></td>
			</tr>
			<tr>
				<td colspan="6" align="center"><dt:button
						id="queryBusiParamBtn" label="查询" type="ok" /></td>
			</tr>
		</table>
		<dt:grid id="busiParamResult" shrinkToFit="true" multiSelect="true"
		...
		<dt:dialog id="editBusiParamDialog" title="编辑系统参数" width="70%">
			...
			<input type="hidden" id="busiParamIdEdit" name="busiParamIdEdit" />
			<dt:dialogbutton text="确定" onClick="editBusiParam"></dt:dialogbutton>
			<dt:dialogbutton text="取消" onClick="cancelEditBusiParamDialog"></dt:dialogbutton>
		</dt:dialog>
	</div>
</body>
</html>