 ...
 * @author CHASE
 */
public class MsgAlarm extends Entity {
	...
	private String equipStateTypeName;
	...
	public String getEquipStateTypeName() {
		return equipStateTypeName;
	}

	public void setEquipStateTypeName(String equipStateTypeName) {
		this.equipStateTypeName = equipStateTypeName;
	}
